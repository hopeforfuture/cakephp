...
echo $this->Form->create(false, array(
    'url' => array('controller' => 'blogs', 'action' => 'edit', $this->request->data['Blog']['id']),
    'id' => 'blogedit',
	'type' => 'file'
));
...
<table>
	...
	<tr>
		...
		?><br/>
		<img src="<?php echo $this->webroot."uploads/".$this->request->data['Blog']['thumb']; ?>" width="120" height="80" />
		</td>
	</tr>
