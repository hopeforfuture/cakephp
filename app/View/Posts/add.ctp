...
<table>
	...
	<tr>
		...
		<td>:</td>
		<td>
			<?php echo $this->Form->input('title', array('label'=>false,  'maxlength'=>false, 'required'=>true, 'value'=>$title_val, 'error'=>false)); ?>
		</td>
	</tr>
	<tr>
		<td>Body</td>
		<td>:</td>
		<td>
			<?php echo $this->Form->input('content', array('label'=>false,  'rows'=>3, 'maxlength'=>false, 'required'=>true, 'value'=>$content_val, 'error'=>false)); ?>
		</td>
	</tr>
	<tr>
		<td colspan="3" align="center">
